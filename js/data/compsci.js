...
/* NEA section (below) is manually authored — preserved by the generator. */
window.KOS_DATA = window.KOS_DATA || {};
window.KOS_DATA.compsci = {
  "id": "compsci",
  "name": "Computer Science",
  "board": "AQA 7517",
  "labelL": "Content (spec wording)",
  "labelR": "Additional information",
  "sections": [
    {
      "ref": "4.1",
      ...
      "children": [
        {
          ...
          "children": [
            ...
            {
              "ref": "4.1.1.6",
              "title": "Constants and variables in a programming language",
              "content": [
            ...
            {
              "ref": "4.1.1.10",
              "title": "Subroutines (procedures/functions)",
              "content": [
            ...
            {
              "ref": "4.1.1.11",
              "title": "Parameters of subroutines",
              "content": [
            ...
            {
              "ref": "4.1.1.12",
              "title": "Returning a value/values from a subroutine",
              "content": [
            ...
            {
              "ref": "4.1.1.13",
              "title": "Local variables in subroutines",
              "content": [
            ...
            {
              "ref": "4.1.1.14",
              "title": "Global variables in a programming language",
              "content": [
            ...
            {
              "ref": "4.1.1.15",
              "title": "Role of stack frames in subroutine calls",
              "content": [
        ...
        },
        {
          ...
          "children": [
            ...
            {
              "ref": "4.1.2.2",
              "title": "Procedural-oriented programming",
              "content": [
      ...
      "children": [
        {
          ...
          "children": [
            ...
            {
              "ref": "4.2.1.2",
              "title": "Single- and multi-dimensional arrays (or equivalent)",
              "content": [
            ...
            {
              "ref": "4.2.1.3",
              "title": "Fields, records and files",
              "content": [
            ...
            {
              "ref": "4.2.1.4",
              "title": "Abstract data types/data structures",
              "content": [
        ...
        },
        {
          ...
          "children": [
            {
              "ref": "4.2.5.1",
              "title": "Trees (including binary trees)",
              "content": [
          ...
          "children": [
            {
              ...
              "info": [
                ...
                "f : S → ℝ the set S = {0,1,2,3} and the co-domain, ℝ, the set of Reals",
                ...
                "The dot product of two vectors, u and v, u = [u , …., u ] and v = [v , ….., v ] is 1 n 1 n u ∙ v = u v + u v + …… + u v 1 1 2 2 n n",
      ...
      "children": [
        {
          ...
          "children": [
            {
              "ref": "4.3.1.1",
              "title": "Simple graph-traversal algorithms",
              "content": [
        ...
        },
        {
          ...
          "children": [
            {
              "ref": "4.3.2.1",
              "title": "Simple tree-traversal algorithms",
              "content": [
              ...
              "info": [
                ...
                "Notation) conversions, producing a postfix expression from an expression tree, emptying a tree."
              ],
              "children": []
            }
          ]
        },
        {
          ...
          "children": [
            {
              "ref": "4.3.3.1",
              "title": "Reverse Polish – infix transformations",
              "content": [
          ...
          "children": [
            ...
            },
            {
              ...
              "info": [
                ...
                "Conquer' approach to problem solving. Time complexity is O(nlog n)."
              ],
              "children": []
            }
          ]
      ...
      "children": [
        {
          ...
          "children": [
            ...
            {
              "ref": "4.4.1.2",
              "title": "Following and writing algorithms",
              "content": [
        ...
        },
        {
          ...
          "children": [
            {
              "ref": "4.4.2.1",
              "title": "Finite state machines (FSMs) with and without output",
              "content": [
            ...
            {
              "ref": "4.4.2.2",
              "title": "Maths for regular expressions",
              "content": [
                "Be familiar with the concept of a set and the following notations for specifying a set:",
                "A = {1, 2, 3, 4, 5 } or set comprehension:",
                "A = {x | x ∈ ℕ ∧ x ≥ 1 } where A is the set consisting of those objects x such that x ∈ ℕ and x ≥ 1 is true.",
              ...
              "info": [
                ...
                "For example, {0n1n | n ≥ 1} = {01, 0011, 000111, 00001111, … }",
                ...
                "The set of real numbers is not countable. The cardinality of a finite set is the number of elements in a set. Cartesian product of two sets,",
                "X and Y, written X x Y and read 'X cross Y', is the set of all ordered pairs (a, b) where a is a member of A and b is a member of B.",
                ...
                "⊆ includes both ⊂ and =, for example {0, 1, 2, 3 } ⊆ {0, 1, 2, 3 } is also true, because {0, 1, 2, 3 } = {0, 1, 2, 3 }. A countable set is a set with the same cardinality (number of elements) as some subset of natural numbers.",
        ...
        },
        {
          ...
          "children": [
            {
              "ref": "4.4.3.1",
              "title": "Backus-Naur Form (BNF)/syntax diagrams",
              "content": [
        ...
        },
        {
          ...
          "children": [
            ...
            {
              "ref": "4.4.4.2",
              "title": "Maths for understanding Big-0 notation",
              "content": [
                ...
                "• a logarithmic function, for example y = log x.",
      ...
      "children": [
          ...
          "children": [
            {
              ...
              "info": [
                ...
                "Base 10: Number , eg 67 10 10",
                "Base 2: Number , eg 10011011 2 2",
                "Base 16: Number , eg AE 16 16"
              ],
              "children": []
            }
          ]
        ...
        },
        {
          ...
          "children": [
            ...
            {
              "ref": "4.5.4.3",
              "title": "Signed binary using two’s complement",
              "content": [
            ...
            {
              "ref": "4.5.4.4",
              "title": "Numbers with a fractional part",
              "content": [
            ...
            {
              "ref": "4.5.4.8",
              "title": "Normalisation of floating point form",
              "content": [
          ...
          "children": [
            ...
            },
            {
              ...
              "info": [
                ...
                "Caesar and Vernam ciphers are at opposite extremes. One offers perfect security, the other doesn’t. Between these two types are ciphers that are computationally secure – see below.",
                "Students will be assessed on the two types.",
                "Ciphers other than Caesar may be used to assess students' understanding of the principles involved. These will be explained and be similar in terms of computational complexity.",
                "Since the key k is chosen uniformly at random, the ciphertext c is also distributed uniformly.",
                "The key k must be used once only. The key k is known as a one-time pad.",
                "Vernam cipher is the only one to have been mathematically proved to be completely secure.",
                "The worth of all other ciphers ever devised is based on computational security. In theory, every cryptographic algorithm except for",
                "Vernam cipher can be broken, given enough ciphertext and time."
              ],
              "children": []
            }
          ]
      ...
      "children": [
        {
          ...
          "children": [
            ...
            {
              "ref": "4.6.1.4",
              "title": "Role of an operating system (OS)",
              "content": [
          ...
          "children": [
            {
              ...
              "info": [
                ...
                "IEEE standard 91-1984 Distinctive shape logic gate symbols for these logic gates.",
      ...
      "children": [
          ...
          "children": [
            {
              ...
              "content": [
                ...
                "Neumann and Harvard architectures and describe where each is typically used.",
        ...
        },
        {
          ...
          "children": [
            {
              "ref": "4.7.2.1",
              "title": "The meaning of the stored program concept",
              "content": [
        ...
        {
          "ref": "4.7.3",
          "title": "Structure and role of the processor and its components",
          "children": [
            {
              "ref": "4.7.3.1",
              "title": "The processor and its components",
              "content": [
            ...
            {
              "ref": "4.7.3.2",
              "title": "The Fetch-Execute cycle and the role of registers within it",
              "content": [
            ...
            },
            {
              ...
              "info": [
                ...
                "For example, 4 bits have been allocated to the opcode (3 bits for basic machine operation, eg",
                "ADD, and 1 bit for the addressing mode). 4 bits have been allocated to the operand, making the instruction, opcode + operand, 8 bits in length.",
                "In this example, 16 different opcodes are possible (24 = 16)."
              ],
              "children": []
            },
            {
            ...
            {
              "ref": "4.7.3.5",
              "title": "Machine-code/assembly language operations",
              "content": [
            ...
            },
            {
              ...
              "title": "Interrupts",
              "content": [
                "Describe the role of interrupts and interrupt service routines (ISRs); their effect on the",
                "Fetch-Execute cycle; and the need to save the volatile environment while the interrupt is being serviced."
              ],
              "info": [],
              "children": []
            },
      ...
      "children": [
        {
          ...
          "info": [
            ...
            "Hypotheticals allow students to isolate quickly important ethical principles in an artificially simplified context. For example, a teacher might ask students to explain and defend how, as a",
            "Google project manager, they would evaluate a proposal to bring Google’s Street View technology to a remote African village. What questions should be asked? Who should be consulted? What benefits, risks and safeguards considered? What are the trade-offs?",
            "Case studies allow students to confront the tricky interplay between the sometimes competing ethical values and principles relevant in real world settings. For example, the Google",
            "Street View case might be used to tease out the ethical conflicts between individual and cultural expectations, the principle of informed consent,",
            "Street View’s value as a service, its potential impact on human perceptions and behaviours, and its commercial value to Google and its shareholders.",
      ...
      "children": [
        ...
        },
        {
          ...
          "children": [
            ...
            {
              "ref": "4.9.2.2",
              "title": "Types of networking between hosts",
              "content": [
            ...
            },
            {
              ...
              "content": [
                ...
                "Multiple Access with Collision Avoidance (CSMA/CA) with and without Request to Send/",
              ...
              "info": [
                ...
                "WPA (Wifi Protected Access)/WPA2, SSID (Service Set Identifier) broadcast disabled,",
                "MAC (Media Access Control) address allow list.",
                "Knowledge of Carrier Sense Multiple Access/",
                "Collection Detection (CSMA/CD) as used in, for example, Ethernet, is not required."
              ],
              "children": []
            }
          ]
        ...
        {
          "ref": "4.9.4",
          "title": "The Transmission Control Protocol/Internet Protocol (TCP/IP)",
          "info": [],
          "children": [
            {
              "ref": "4.9.4.1",
            ...
            {
              "ref": "4.9.4.2",
              "title": "Standard application layer protocols",
              "content": [
                ...
                "TCP connection to a remote port for the purpose of sending commands to this port using application level protocols such as GET for",
            ...
            },
            {
              ...
              "info": [
                ...
                "The Websocket specification defines an API (Application Programming Interface) establishing a full-duplex 'socket' connection between a web browser and a server over TCP.",
                "This means that there is a persistent connection between client and server, allowing both parties to send data at any time.",
                ...
                "Interface) created and run on server, browser Javascript calls API",
                "• JSON (JavaScript Object Notation) or",
                "XML can be used to transmit data between a server and web application",
                "• Javascript referenced by HTML file, eg index.html, is run in browser.",
            ...
            {
              "ref": "4.9.4.11",
              "title": "Thin- versus thick-client computing",
              "content": [
      ...
      "children": [
        {
          ...
          "content": [
            ...
            "Produce entity relationship diagrams representing a data model and entity descriptions in the form: Entity1 (Attribute1,",
            "Attribute2, .... )."
          ],
          "info": [
        ...
        {
          "ref": "4.10.3",
          "title": "Database design and normalisation techniques",
          "content": [
      ...
      "children": [
          ...
          "children": [
            {
              ...
              "info": [
                "Loosely speaking, a function is a rule that, for each element in some set A of inputs, assigns an output chosen from set B, but without necessarily using every member of B. For example, f: {a,b,c,…z} → {0,1,2,…,25} could use the rule that maps a to 0, b to 1, and so on, using all values which are members of set B.",
            ...
            },
            {
              ...
              "info": [
                ...
                "The type of the function is f: integer x integer → integer where integer x integer is the Cartesian product of the set integer with itself.",
            ...
            },
            {
              ...
              "info": [
                ...
                "Viewed as follows in the partial function application scheme:",
                "add: integer → (integer → integer) add 4 returns a function which when applied to another integer adds 4 to that integer.",
            ...
            },
            {
              ...
              "info": [
                ...
                "Given two functions f: A → B g: B → C function g ○ f, called the composition of g and f, is a function whose domain is A and co-domain is C.",
                "If the domain and co-domains of f and g are ℝ, and f(x) = (x + 2) and g(y) = y3. Then g ○ f = (x + 2)3 f is applied first and then g is applied to the result returned by f."
              ],
              "children": []
            }
          ]
        },
        {
          ...
          "children": [
            {
              "ref": "4.12.2.1",
              "title": "Functional language programs",
              "content": [
          ...
          "children": [
            {
              ...
              "content": [
                ...
                "Requirements of system must be established by interaction with the intended users of the system. The process of clarifying requirements may involve prototyping/agile approach."
              ],
              "info": [
            ...
            },
            {
              ...
              "title": "Testing",
              "content": [
                "Be aware that the solution needs to be tested for errors using appropriate test data (normal, boundary and erroneous data).",
                "Be aware that the solution needs to be tested for efficiency using logical reasoning."
              ],
              "info": [],
              "children": []
            },
            {
              ...
              "title": "Evaluation",
              "content": [
                "Be aware that the solution needs to be evaluated against the initial requirements."
              ],
              "info": [],
              "children": []
            }
